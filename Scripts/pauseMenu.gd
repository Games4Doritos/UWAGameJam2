...
func _input(event: InputEvent) -> void:
	...
	if event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and continueSelected:
	...
	elif event is InputEventMouseButton and event.button_index == MOUSE_BUTTON_LEFT and leaveSelected:
		get_tree().paused = false
